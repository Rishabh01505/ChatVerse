...
//ctrl+shift+L - to replace a word everywhere in file or write somrthing everywhere
function Login() {
        ...
        <div className='flex h-screen items-center justify-center'>
          <form onSubmit={handleSubmit(onSubmit)} className='border border-white px-6 py-2 rounded-md space-y-3 w-96'>
            ...
            <div className='flex justify-between'>
                <p className='text-white'>New user?<Link to="/signup" className='text-blue-500 underline cursor-pointer ml-1'>Signup</Link></p>
